    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('amount')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="1650" :duration="3000" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('message')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="81" :duration="3200" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('visitor')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="3341" :duration="3600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
  </el-row>
